...
function injectedScript(win) {
  ...
  function attemptPatchWeb3() {
    ...
    // ['getAccounts', 'gasPrice', 'sendTransaction'].forEach((fnName) => {
    //   const _originalFn = globalWeb3.eth[fnName];
    //   globalWeb3.eth[fnName] = (...args) => {
    //     console.log('STUB!');
    //     return _originalFn.apply(globalWeb3.eth, args);
    //   };
    // });
